...
$data = ['url' => 'https://static.api4.ai/samples/household-stuff-1.jpg'];
...
// Parse response and get.
arsort($raw_response['results'][0]['entities'][0]['mapping']);
$items = $raw_response['results'][0]['entities'][0]['mapping'];
