...
const image = process.argv[2] || 'https://static.api4.ai/samples/household-stuff-1.jpg'
...
axios.post(OPTIONS[MODE].url, form, { headers })
  .then(function (response) {
    ...
    const items = response.data.results[0].entities[0].mapping
    console.log(`💬 Stuff item(s):\n${JSON.stringify(items)}\n`)
  })
