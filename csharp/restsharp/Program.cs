...
// Prepare request.
String image = args.Length > 0 ? args[0] : "https://static.api4.ai/samples/household-stuff-1.jpg";
...
JsonObject items = docRoot["results"]![0]!["entities"]![0]!["mapping"]!.AsObject();
Console.WriteLine("[i] Stuff item(s):");
