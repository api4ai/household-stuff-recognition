...
//  sample
//
//  Created by API4AI Team on 09/02/2024.
//
...
let OPTIONS = [
    "normal": [
        "url": "https://api4ai.cloud/household-stuff/v1/results",
...
let image = CommandLine.arguments.count > 1 ? CommandLine.arguments[1] : "https://static.api4.ai/samples/household-stuff-1.jpg"
var httpBody: Data;
if (image.contains("://")) {
    // POST image via URL.
    ...
    if (error != nil) {
        ...
        do {
            ...
            if (status["code"] == "ok") {
                ...
                var items = entity["mapping"] as! [String:NSNumber]
                for item in items {
